defmodule NoshNetworkWeb.CoreComponents do
  @moduledoc """
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "my-3 block w-full rounded-lg text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NoshNetworkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NoshNetworkWeb.Gettext, "errors", msg, opts)
    end
  end
